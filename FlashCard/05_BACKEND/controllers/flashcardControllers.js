    ...
    // Function to get all flashcards owned by the token owner and public flashcards
    const getAllFlashcards = async (req, res) => {
        try {
            ...
            res.status(200).send({ message: "Retrieve Data Successfully", data: flashcards })
        } catch (error) {
            console.error(error)
    ...
    // Function to get a specific single flashcard owned by the token owner or public
    const getSingleFlashcard = async (req, res) => {
        try {
            ...
            res.status(200).send({ message: "Retrieved Data Successfully", data: flashcard })
        } catch (error) {
            console.error(error)
            res.status(500).send({ error: "Failed to fetch flashcard" })
        }
    }
    ...
    const postFlashcard = async (req, res) => {
        try {
            ...
            res.status(201).send({ message: "New flashcard created", data: savedFlashcard })
        } catch (error) {
            console.error(error)
            res.status(500).send({ error: "Failed to create flashcard" })
        }
    }
    ...
    const updateFlashcard = async (req, res) => {
        try {
            ...
            res.status(200).send({ message: "Flashcard updated", data: updatedFlashcard })
        } catch (error) {
            console.error(error)
            res.status(500).send({ error: "Failed to update flashcard" })
        }
    }
    ...
    const deleteFlashcard = async (req, res) => {
        try {
            ...
            console.error(error)
            res.status(500).send({ error: "Failed to delete flashcard" })
        }
    }
